...
- [ ] **SM-308** — Дополнительная статистика и объяснимое детектирование аномалий расхода.
  ...
  **SM-308d GUI slice доставлен отдельным PR (PR #45, merged).** Session Report Inspector
  ...
  - [ ] **SM-308e** — Задать account profile provenance для импортируемых источников.
    ...
    проверки пройдены, GitHub CI прошёл на ревизии реализации; финальная docs-only ревизия
    с правилом no-wait отправлена и оставлена проверяться на GitHub. Ветка `feat/sm-308e-account-provenance`
...
- [x] **SM-314** — Зафиксировать вертикальную шкалу request timeline на всём диапазоне сессии.
  Доставлена через [PR #36](https://github.com/SoundBlaster/SessionMonitor/pull/36), merge `4fa6231`
...
- [x] **SM-316** — Показывать общие import diagnostics как служебные данные.
  Доставлено через [PR #49](https://github.com/SoundBlaster/SessionMonitor/pull/49), merge
...
- [x] **SM-318** — Удалить устаревшие Xcode warnings в watch controller и timeline scale.
  ...
  Workflow lint, Native checks и CI прошли на обновлённой ветке; review thread закрыт.
