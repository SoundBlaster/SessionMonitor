...
- [ ] **SM-314** — Зафиксировать вертикальную шкалу request timeline на всём диапазоне сессии.
  **Статус: PR [#36](https://github.com/SoundBlaster/SessionMonitor/pull/36) открыт; CI прошёл на ревизии `e5e62a3` (2026-09-21), ветка `fix/sm-314-stable-timeline-y-scale`.** Сейчас Swift Charts
